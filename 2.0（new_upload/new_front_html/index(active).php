...
<script type="text/javascript">
    function checkusername()
    {
        ...
        var slist = '<?php echo urlencode(json_encode($users));?>';
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="for_LoginAndRegister/login_register_process.php" id="formLogin">
                                <table>
                                    <tr><td><p class="blank"> </td></tr>
                                    <tr><td><p class="login_words">用户名</p></td><td><input type="text" name="username" class="form-control"></td></tr>
                                    <tr><td><p class="blank"> </td></tr>
                                    <tr><td><p class="login_words">密码</p></td><td><input type="password" name="password" class="form-control"></td></tr>
                                    <tr><td><p class="blank"> </td></tr>
                                    <tr><td><button style="margin-left: 130px;" type="submit" class="btn btn-success">登录</button></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">忘记了密码？</a></td></tr>
                                </table>
                            </form>
                        </div>
        ...
        <div class="modal fade" id="myModal1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- 模态框主体 -->
                    <div class="modal-body">
                        <form method="post" action="for_LoginAndRegister/login_register_process.php" id="formRegister" onsubmit="return checkform()">
                            <table>
                                <tr><td><p class="blank"> </td></tr>
                                <tr><td><p class="register_words">用户名</p></td><td><input type="text" name="newUser" class="form-control" placeholder="用户名长度为4-10" datatype="s4-10" onchange="checkusername()"></td><td><div id="errusername" align="center"></div></td></tr>
                                <tr><td><p class="blank"> </td></tr>
                                <tr><td><p class="register_words">密码</p></td><td><input type="password" name="newPassword" class="form-control" placeholder="密码长度为8-16" maxlength="16" onchange="checkpassword()"></td><td><div id="errpassword" align="center"></div></td></tr>
                                <tr><td><p class="blank"> </td></tr>
                                <tr><td><p class="register_words">重复密码</p></td><td><input type="password" name="newRePassword" class="form-control" placeholder="重复上面输入的密码" onchange="checkpasswordagain()"></td><td><div id="errrepassword" align="center"></div></td></tr>
                                <tr><td><p class="blank"> </td></tr>
                                <tr><td><p class="register_words">邮箱</p></td><td><input type="text" name="newEmail" class="form-control"></td></tr>
                                <tr><td><p class="blank"> </td></tr>
                                <tr><td><p class="register_words">QQ</p></td><td><input type="text" name="newQQ" class="form-control"></td><td><div id="errqq" align="center"></div></td></tr>
                                <tr><td><p class="blank"> </td></tr>
                                <tr><td><p class="register_words">PIN</p></td><td><input type="password" name="newPIN" class="form-control" placeholder="4位，用来找回密码" maxlength="4" onchange="checkpin()"></td><td><div id="errpin" align="center"></div></td></tr>
                                <tr><td><p class="blank"> </td></tr>
                                <tr><td><p class="register_words">重复PIN</p></td><td><input type="password" name="newRePIN" class="form-control" placeholder="重复上面的安全码" maxlength="4" onchange="checkpinagain()"></td><td><div id="reerrpin" align="center"></div></td></tr>
                                <tr><td><p class="blank"> <option name="register_symbol" value="1"></td></tr>
                                <tr><td><button style="margin-left: 130px;" type="submit" class="btn btn-success">注册</button></td><td><div style="font-size: smaller; color: gray;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注册成功后自动登录</div></td></tr>
                            </table>
                    </div>
