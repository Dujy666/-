...
<form action="login_register_do.php" method="post" id="form1" onsubmit="return checkform()">
    <table class="login_register_table">
        ...
        <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
        <tr><td><strong><font size="3" color="white">PIN码</font></strong></td><td>&nbsp;</td><td><input type="text" name="safecode" class="form-control" id="safecode" placeholder="四位数字用以找回密码" ></td><td><div id="errpin" align="center"></div></td></tr>
        <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
